            ...
            public void onSelectedChanged(RecyclerView.ViewHolder viewHolder, int actionState) {
                if (viewHolder != null) {
                    ...
                    if (this.listener.getClass().getSimpleName().equals("ListActivity")) {
                        backgroundViewEdit = ((AplicationAdapter.MyViewHolder) viewHolder).viewBackgroundEdit;
                        backgroundViewDelete = ((AplicationAdapter.MyViewHolder) viewHolder).viewBackgroundDelete;
                        foregroundView = ((AplicationAdapter.MyViewHolder) viewHolder).viewForeground;
                    }
                    //Selected item
